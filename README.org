...
*** Update pom.xml
    https://juxt.pro/blog/pack-maven#_generate_a_pom_xml
...
*** Install the pack alias
    https://juxt.pro/blog/pack-maven#_install_the_pack_alias
...
*** Build your JAR
    https://juxt.pro/blog/pack-maven#_build_your_jar
...
*** Release the JAR using Deps Deploy
    https://juxt.pro/blog/pack-maven#deps_deploy
